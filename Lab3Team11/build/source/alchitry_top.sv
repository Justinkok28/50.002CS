...
module alchitry_top (
    ...
    localparam _MP_STAGES_1490455444 = 3'h4;
    logic M_reset_cond_in;
    logic M_reset_cond_out;
    
    reset_conditioner #(
        .STAGES(_MP_STAGES_1490455444)
    ) reset_cond (
        .clk(clk),
        .in(M_reset_cond_in),
    ...
    localparam _MP_CLK_FREQ_433758128 = 24'h989680;
    ...
    alu_manual_tester #(
        .CLK_FREQ(_MP_CLK_FREQ_433758128)
    ) alu_manual (
        .clk(clk),
        .rst(rst),
        .io_button(io_button),
    ...
    localparam _MP_CLK_FREQ_982012571 = 24'h989680;
    ...
    alu_auto_tester #(
        .CLK_FREQ(_MP_CLK_FREQ_982012571)
    ) alu_auto (
        .clk(clk),
        .rst(rst),
        .io_button(io_button),

...
module alu_auto_tester #(
    ...
    localparam _MP_RISE_1679296156 = 1'h1;
    localparam _MP_FALL_1679296156 = 1'h0;
    logic M_slow_clock_edge_in;
    logic M_slow_clock_edge_out;
    
    edge_detector #(
        .RISE(_MP_RISE_1679296156),
        .FALL(_MP_FALL_1679296156)
    ) slow_clock_edge (
        .clk(clk),
    ...
    localparam logic [4:0][0:0] _MP_RISE_1068362933 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_1068362933 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_1068362933;
    
    generate
        for (idx_0_1068362933 = 0; idx_0_1068362933 < 5; idx_0_1068362933 = idx_0_1068362933 + 1) begin: forLoop_idx_0_1068362933
            edge_detector #(
                .RISE(_MP_RISE_1068362933[idx_0_1068362933]),
                .FALL(_MP_FALL_1068362933[idx_0_1068362933])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_1068362933]),
                .out(M_io_button_edge_out[idx_0_1068362933])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][26:0] _MP_CLK_FREQ_176346637 = {{27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100, 27'h5f5e100}};
    localparam _MP_MIN_DELAY_176346637 = 5'h14;
    localparam _MP_NUM_SYNC_176346637 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_176346637;
    
    generate
        for (idx_0_176346637 = 0; idx_0_176346637 < 5; idx_0_176346637 = idx_0_176346637 + 1) begin: forLoop_idx_0_176346637
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_176346637[idx_0_176346637]),
                .MIN_DELAY(_MP_MIN_DELAY_176346637),
                .NUM_SYNC(_MP_NUM_SYNC_176346637)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_176346637]),
                .out(M_io_button_cond_out[idx_0_176346637])
            );
        end
    endgenerate
    ...
    localparam _MP_DIGITS_1226934562 = 3'h4;
    localparam _MP_DIV_1226934562 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_1226934562),
        .DIV(_MP_DIV_1226934562)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),

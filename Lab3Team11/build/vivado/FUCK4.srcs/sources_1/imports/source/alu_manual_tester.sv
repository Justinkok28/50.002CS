...
module alu_manual_tester #(
    ...
    localparam logic [4:0][0:0] _MP_RISE_802764104 = {{1'h1, 1'h1, 1'h1, 1'h1, 1'h1}};
    localparam logic [4:0][0:0] _MP_FALL_802764104 = {{1'h0, 1'h0, 1'h0, 1'h0, 1'h0}};
    logic [4:0] M_io_button_edge_in;
    logic [4:0] M_io_button_edge_out;
    
    genvar idx_0_802764104;
    
    generate
        for (idx_0_802764104 = 0; idx_0_802764104 < 5; idx_0_802764104 = idx_0_802764104 + 1) begin: forLoop_idx_0_802764104
            edge_detector #(
                .RISE(_MP_RISE_802764104[idx_0_802764104]),
                .FALL(_MP_FALL_802764104[idx_0_802764104])
            ) io_button_edge (
                .clk(clk),
                .in(M_io_button_edge_in[idx_0_802764104]),
                .out(M_io_button_edge_out[idx_0_802764104])
            );
        end
    endgenerate
    
    
    localparam logic [4:0][9:0] _MP_CLK_FREQ_322678256 = {{10'h3e8, 10'h3e8, 10'h3e8, 10'h3e8, 10'h3e8}};
    localparam _MP_MIN_DELAY_322678256 = 5'h14;
    localparam _MP_NUM_SYNC_322678256 = 2'h2;
    logic [4:0] M_io_button_cond_in;
    logic [4:0] M_io_button_cond_out;
    
    genvar idx_0_322678256;
    
    generate
        for (idx_0_322678256 = 0; idx_0_322678256 < 5; idx_0_322678256 = idx_0_322678256 + 1) begin: forLoop_idx_0_322678256
            button_conditioner #(
                .CLK_FREQ(_MP_CLK_FREQ_322678256[idx_0_322678256]),
                .MIN_DELAY(_MP_MIN_DELAY_322678256),
                .NUM_SYNC(_MP_NUM_SYNC_322678256)
            ) io_button_cond (
                .clk(clk),
                .in(M_io_button_cond_in[idx_0_322678256]),
                .out(M_io_button_cond_out[idx_0_322678256])
            );
        end
    endgenerate
    ...
    localparam _MP_DIGITS_149909301 = 3'h4;
    localparam _MP_DIV_149909301 = 5'h10;
    logic [3:0][3:0] M_seg_values;
    logic [6:0] M_seg_seg;
    logic [3:0] M_seg_sel;
    
    multi_seven_seg #(
        .DIGITS(_MP_DIGITS_149909301),
        .DIV(_MP_DIV_149909301)
    ) seg (
        .clk(clk),
        .rst(rst),
        .values(M_seg_values),
